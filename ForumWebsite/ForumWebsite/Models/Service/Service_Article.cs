...
{
    public class Service_Article : IService_Article
    {
        protected IRepository_Article Repository_Article_P { get; private set; }
        public Service_Article() : this(null) { }
        public Service_Article(IRepository_Article Repository_Article_Val)
        {
            Repository_Article_P = Repository_Article_Val ?? new Repository_Article();
        }
